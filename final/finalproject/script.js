...
startGame.addEventListener('click',function(event){
    ...
    document.getElementById('quit').addEventListener("click", function(){
        ...
        function setUpTurn() {
            instruct.innerHTML = `<h2>Pick 2 cards for <strong>${gameData.players[gameData.index]}</strong></h2>`;
            actionArea.innerHTML = '<button id="roll">Pick 2 Cards</button>';
        ...
        function throwDice(){
            ...
            instruct.innerHTML = `<h2>Pick 2 cards for the ${gameData.players[gameData.index]}<h2>`;
            ...
            // if neither die is a 1
                ...
                instruct.innerHTML = `<h2>Yay your score has <strong>INCREASED</strong>!</h2>`;
